...
const Contact = () => {
    ...
    async function makeGetRequest() {
        const contactContent = await axios.get('http://cms.website.com/wp-json/wp/v2/pages/114')
        const newsContent = await axios.get('http://cms.website.com/wp-json/wp/v2/news')
                    ...
                    <div className="container contact-container py-5">
                        ...
                        <div className="row">
                            <div className="col-12 py-5 text-center">
                                <h1>Newsroom</h1>
                                <p>For press inquiries, email <a href="mailto:hello@website.com">here</a></p>
                            </div>
