...
const Blog = () => {
    ...
    async function makeGetRequest() {
        const callblogPage = await axios.get('http://cms.website.com/wp-json/wp/v2/pages/112')
        const callBlogs = await axios.get('http://cms.website.com/wp-json/wp/v2/posts')
        const callCats = await axios.get('http://cms.website.com/wp-json/wp/v2/categories')
